...
#define SET_U3_AS_AN_OUTPUT             CHIP_ENABLE_U3_DDR |= CHIP_ENABLE_U3_BIT
...
#define SET_U2_AS_AN_OUTPUT             CHIP_ENABLE_U2_DDR |= CHIP_ENABLE_U2_BIT
...
#define TURN_OFF_HOLD_U3                HOLD_U3_PORT |= HOLD_U3_BIT
...
#define TURN_OFF_HOLD_U2                HOLD_U2_PORT |= HOLD_U2_BIT

#define WRITE_PROTECT_BIT				BIT1
#define WRITE_PROTECT_PORT				P2OUT
#define WRITE_PROTECT_DIR				P2DIR
#define SET_WRITE_PROTECT               WRITE_PROTECT_DIR    |= WRITE_PROTECT_BIT
#define TURN_OFF_WRITE_PROTECT          WRITE_PROTECT_PORT &= ~WRITE_PROTECT_BIT
