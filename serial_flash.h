...
#define SET_CHIP_ENABLE_U3_AS_OUTPUT           CHIP_ENABLE_U3_DDR |= CHIP_ENABLE_U3_BIT
#define DISABLE_FLASH_MEMORY_U3                    CHIP_ENABLE_U3_PORT |= CHIP_ENABLE_U3_BIT
#define ENABLE_FLASH_MEMORY_U3                   CHIP_ENABLE_U3_PORT &= ~CHIP_ENABLE_U3_BIT
...
#define SET_CHIP_ENABLE_U2_AS_OUTPUT           CHIP_ENABLE_U2_DDR |= CHIP_ENABLE_U2_BIT
#define DISABLE_FLASH_MEMORY_U2                   CHIP_ENABLE_U2_PORT |= CHIP_ENABLE_U2_BIT
#define ENABLE_FLASH_MEMORY_U2                   CHIP_ENABLE_U2_PORT &= ~CHIP_ENABLE_U2_BIT

#define HOLD_U3_BIT						BIT2
#define HOLD_U3_PORT					P2OUT
#define HOLD_U3_DIR						P2DIR
#define ENABLE_U3_HOLD_AS_OUTPUT        HOLD_U3_DIR |= HOLD_U3_BIT
#define DISABLE_U3_HOLD                  HOLD_U3_PORT |= HOLD_U3_BIT
#define ENABLE_U3_HOLD                 HOLD_U3_PORT &= ~HOLD_U3_BIT

#define HOLD_U2_BIT						BIT3
#define HOLD_U2_PORT					P2OUT
#define HOLD_U2_DIR						P2DIR
#define ENABLE_U2_HOLD_AS_OUTPUT        HOLD_U2_DIR |= HOLD_U2_BIT
#define DISABLE_U2_HOLD                  HOLD_U2_PORT |= HOLD_U2_BIT
#define ENABLE_U2_HOLD                 HOLD_U2_PORT &= ~HOLD_U2_BIT

#define WRITE_PROTECT_BIT				BIT1
#define WRITE_PROTECT_PORT				P2OUT
#define WRITE_PROTECT_DIR				P2DIR
#define ENABLE_WRITE_PROTECT_AS_OUTPUT       WRITE_PROTECT_DIR |= WRITE_PROTECT_BIT
